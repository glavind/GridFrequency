...
The data is returned as a monthly zip file containing one csv file with 10 second measurements in Hz. The format of the date is local time (Europe/Paris), with NA for hour 3 (02:00:00-02:59:50) in spring DST and presumably removal of one hour in the autumn DST.
